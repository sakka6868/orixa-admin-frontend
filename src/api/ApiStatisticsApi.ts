...
const ApiStatisticsApi = {
    ...
    getStatistics: async (query: ApiStatisticsQuery): Promise<ApiStatistics[]> => {
        return await requesterWithAuthenticationInstance.get(`/analysis/monitor/api/statistics`, {
            params: query
        });
    },
