      ...
      <div className="relative flex flex-col items-center justify-center w-full min-h-screen p-6 overflow-hidden z-1">
        ...
        <div>
          <div className="mx-auto w-full max-w-[460px] text-center">
            ...
            <h1 className="mb-3 bg-gradient-to-r from-brand-500 to-brand-700 bg-clip-text text-transparent font-bold text-title-md xl:text-title-xl">
              即将上线
            </h1>

            <p className="text-base app-text-muted mb-9">
              新功能正在紧张开发中，输入您的邮箱以获取最新动态与上线通知。
            </p>

            {/* 倒计时 */}
            <CountdownTimer targetDate={targetDate} />

            <p className="mb-5 text-sm app-text-secondary">
              不想错过上线消息？立即订阅
            </p>
            ...
            <form>
              <div className="flex flex-col gap-2 sm:flex-row sm:gap-3">
                ...
                <button
                  type="submit"
                  className="flex items-center justify-center w-full gap-2 px-4 py-3 text-sm font-medium text-white bg-brand-500 rounded-lg hover:bg-brand-600 transition-colors sm:w-auto"
                >
                  <svg
          ...
          <div className="absolute -translate-x-1/2 bottom-6 left-1/2">
            <p className="mt-20 mb-6 text-base text-center app-text-muted">
              关注我们
            </p>
            ...
            <div className="flex items-center justify-center gap-5">
              <Link
                to="/"
                className="app-text-muted hover:text-gray-800 dark:hover:text-white/90 transition-colors"
                aria-label="Facebook"
              >
                <svg
                  className="fill-current"
